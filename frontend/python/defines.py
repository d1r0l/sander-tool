...
def getCreds() :
	...
	creds['client_id'] = '280859069578945' # client id from facebook app IG Graph API Test
	creds['client_secret'] = '960332f49b15a755cc4015a8a63600b5' # client secret from facebook app
	creds['graph_domain'] = 'https://graph.facebook.com/' # base domain for api calls
	creds['graph_version'] = 'v6.0' # version of the api we are hitting
	creds['endpoint_base'] = creds['graph_domain'] + creds['graph_version'] + '/' # base endpoint with domain and version
	creds['debug'] = 'no' # debug mode for api call
	creds['page_id'] = '2098916506841276' # users page id
	creds['instagram_account_id'] = '17841405657898548' # users instagram account id
	creds['ig_username'] = 'justinstolpe' # ig username
